...
// GateStreamRequest UID userID, SID sessionID
...
func (m *GateStreamRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.SID != 0 {
		data[i] = 0x10
		i++
		i = encodeVarintGate(data, i, uint64(m.SID))
	}
	return i, nil
}
...
var fileDescriptorGate = []byte{
	...
	,
}
