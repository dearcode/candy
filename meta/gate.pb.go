...
func (m *GateGroupRequest) MarshalTo(data []byte) (int, error) {
	...
	if len(m.Users) > 0 {
		data23 := make([]byte, len(m.Users)*10)
		var j22 int
		for _, num1 := range m.Users {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		data[i] = 0x22
		i++
		i = encodeVarintGate(data, i, uint64(j22))
...
var fileDescriptorGate = []byte{
	...
	,
}
